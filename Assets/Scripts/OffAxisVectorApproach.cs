...
public class OffAxisVectorApproach : MonoBehaviour {
    ...
    //https://stackoverflow.com/questions/44424842/unity3d-focus-cam-in-a-rect-using-project-matrix
    void Update () {
        Vector3 pa, pb, pc, pd;
        ...
        Matrix4x4 p = PerspectiveOffCenter (l, r, b, t, n, f);
